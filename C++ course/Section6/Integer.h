...
public:
  ...
  */
    ...
    // We use operator for casting a user-defined type into a basic type
    // We use keyword explicit to make sure compiler will never cast by itself without the user explicitly invoke the cast
